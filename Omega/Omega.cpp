...
// Omega.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COmegaApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &COmegaApp::OnAppAbout)
...
COmegaApp::COmegaApp()
{
	...
	SetAppID(_T("Omega.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект COmegaApp

COmegaApp theApp;


// инициализация COmegaApp

BOOL COmegaApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_OmegaTYPE,
		RUNTIME_CLASS(COmegaDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(COmegaView));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений COmegaApp
...
void COmegaApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// COmegaApp настройка методов загрузки и сохранения

void COmegaApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void COmegaApp::LoadCustomState()
{
}

void COmegaApp::SaveCustomState()
{
}
